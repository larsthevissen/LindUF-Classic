...
function LindUF:power(p)
  ...
  f.bar:RegisterEvent("VARIABLES_LOADED")
  f.bar:RegisterEvent("PLAYER_ENTERING_WORLD")
  -- f.bar:RegisterEvent("UNIT_TARGET")
  f.bar:SetScript("OnEvent", function(self, event)
    local r, g, b = LindUF.PowerColor(p.unit)
    self.tx:SetColorTexture(r, g, b, .8)
