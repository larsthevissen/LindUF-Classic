...
function LindUF:HealthBar(p)
  ...
  -- tx:SetVertexOffset(1,10,0)
  -- tx:SetVertexOffset(3,10,0)
  ...
  f.txPower = f.Health:CreateTexture()
  f.txPower:SetAllPoints(f.Power)
  -- f.txPower:SetTexture(1, 1, 0, 1)
  -- f.txPower:SetVertexOffset(1,10,0) 
  -- f.txPower:SetVertexOffset(3,10,0)
  f.txPower:SetColorTexture(1,0,0,1)
  f.Health:SetStatusBarTexture(f.txPower)
